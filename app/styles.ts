...
export const styles = StyleSheet.create({
  ...
  inboxContentContainer: { flex: 1 },
  inboxHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 },
  inboxTitle: { fontFamily: 'Fredoka_500Medium', fontSize: 15, color: colors.ink, flex: 1, marginRight: 8 },
  inboxUnreadText: { fontFamily: 'Fredoka_700Bold' },
  inboxTime: { fontFamily: 'Fredoka_400Regular', fontSize: 11, color: colors.inkSoft },
  inboxBody: { fontFamily: 'Fredoka_400Regular', fontSize: 13, color: colors.inkSoft, lineHeight: 18 },
  inboxUnreadDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: colors.accentRed, marginLeft: 8 },
  inboxEmptyContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 100 },
  inboxEmptyText: { marginTop: 16, fontFamily: 'Fredoka_500Medium', fontSize: 16, color: colors.inkSoft },
  ...
  moodLegendTitle: { fontSize: 16, fontFamily: "Fredoka_700Bold", color: colors.ink, marginBottom: 12 },
  moodLegendRow: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
